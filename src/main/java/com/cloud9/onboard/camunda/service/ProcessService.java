		...
		try{
		   ...
		   Session session = Session.getInstance(props, new javax.mail.Authenticator() {
		      protected PasswordAuthentication getPasswordAuthentication() {
		         return new PasswordAuthentication("sharad199994@gmail.com", "roy_1994");
		      }
		   });
		   String messageContent="Welcome "+name.toUpperCase();
		    Message msg = new MimeMessage(session);
		   msg.setFrom(new InternetAddress("sharad199994@gmail.com", false));

		   msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse(receiverMailId));
		   msg.setSubject("On-boarding");
		   msg.setContent("On-boarding", "text/html");
